...
/**
 * This is the item provider adapter for a {@link ejemploDC4.Operacion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperacionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNombrePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Operacion_nombre_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Operacion_nombre_feature",
								"_UI_Operacion_type"),
						EjemploDC4Package.Literals.OPERACION__NOMBRE, true, false, false,
	...
	protected void addVisibilidadPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Operacion_visibilidad_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Operacion_visibilidad_feature",
								"_UI_Operacion_type"),
						EjemploDC4Package.Literals.OPERACION__VISIBILIDAD, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addRetornoPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Operacion_retorno_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Operacion_retorno_feature",
								"_UI_Operacion_type"),
						EjemploDC4Package.Literals.OPERACION__RETORNO, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
